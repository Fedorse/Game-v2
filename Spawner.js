...
export class Spawner {
  ...
  update(deltaTime) {
    ...
    if (
      elapsedTime - this.lastDifficultyIncrease >=
      SPAWN_CONFIG.difficultyIncreaseInterval
    ) {
  ...
  getSpawnPosition() {
    const radius =
      Math.random() * (SPAWN_CONFIG.maxRadius - SPAWN_CONFIG.minRadius) +
      SPAWN_CONFIG.minRadius;
