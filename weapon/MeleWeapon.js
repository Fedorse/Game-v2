...
export class MeleeWeapon extends BaseWeapon {
    ...
    handleAttack(deltaTime){
        if(this.isAttacking){
            ...
            const distanceTraveled = this.calculateDistance(this.startPosition, this.position)
            ...
            if(target){
                const distanceToTarget = this.calculateDistance(this.position, target.position)
